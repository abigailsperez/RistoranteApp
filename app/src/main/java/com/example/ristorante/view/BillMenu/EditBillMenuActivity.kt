...
class EditBillMenuActivity : AppCompatActivity() {
    ...
    fun getBillMenuCategoryFun(view: EditBillMenuActivity){
        ...
        val call = service.getAll(idBill)

        call.enqueue(object : Callback<List<BillMenu>> {
            override fun onResponse(
                call: Call<List<BillMenu>>,
                response: Response<List<BillMenu>>
            ) {
                when {
                    response.code() == 200 -> {
                        ...
                        response.body()!!.forEach {
                            ...
                            //Se llena la tabla
                            val register =
                                LayoutInflater.from(this@EditBillMenuActivity).inflate(R.layout.table_row_billmenu, null, false)
            ...
            override fun onFailure(call: Call<List<BillMenu>>, t: Throwable) {
